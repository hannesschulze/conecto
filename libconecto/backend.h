...
class Backend {
  public:
     ...
     */
    void register_plugin (const std::string& capability, const std::shared_ptr<AbstractPacketHandler>& handler) noexcept;
    /**
    ...
    using type_signal_device_capability_added = sigc::signal<void, const std::shared_ptr<Device>& /* device */,
